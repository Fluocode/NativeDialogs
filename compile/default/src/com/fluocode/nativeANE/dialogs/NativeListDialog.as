...
package com.fluocode.nativeANE.dialogs
{
	...
	public class NativeListDialog extends AbstractNativeDialog
	{
		 ...
		 * <br>com.fluocode.nativeANE.NativeDialogListEvent
		 */
		...
		public function show():Boolean
		{
			...
			try{
				...
				if(isAndroid()) {
					trace("show",_title,_buttons,labels,selected,_cancelable,_androidTheme);
					return true;
				} else if(isIOS()) {
					trace("show",_title,_buttons,labels,selected,_cancelable,_iosTheme,_message);
					return true;
				} else {
					return false;
				}
		 ...
		 * @default com.fluocode.nativeANE.dialogs.NativeListDialogs#DEFAULT_THEME
		 */
