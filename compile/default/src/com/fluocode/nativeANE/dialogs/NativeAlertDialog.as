...
package com.fluocode.nativeANE.dialogs
{
	...
	public class NativeAlertDialog extends AbstractNativeDialog
	{
		...
		public static const DEFAULT_THEME:int = 0x00000005;
		 ...
		 * 
		 * @see com.fluocode.nativeANE.dialogs.NativeAlertDialog.defaultTheme
		 * @see com.fluocode.nativeANE.dialogs.NativeAlertDialog.show
		 * 
		...
		public function show(cancelable:Boolean = true) : Boolean
		{
			try{
				...
				trace("showAlertWithTitleAndMessage", _title, _message, _buttons, cancelable, _theme);
		 ...
		 * @default com.fluocode.nativeANE.dialogs.NativeAlertDialog#DEFAULT_THEME
		 */
		...
		[Deprecated(replacement="com.fluocode.nativeANE.dialogs.NativeAlertDialog#showAlert()")] 
		/**
		 ...
		 * 
		 * @event com.fluocode.nativeANE.events.NativeDialogEvent
		 * 
		 * @see com.fluocode.nativeANE.dialogs.NativeAlertDialog.showAlert
		 */
