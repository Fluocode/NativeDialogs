...
{
	CGFloat maxWidth = self.width - (kTSAlertView_LeftMargin * 2);
    //CGSize s = [self.titleLabel.text boundingRectWithSize:options:attributes:context:: self.titleLabel.font constrainedToSize: CGSizeMake(maxWidth, 1000) lineBreakMode: self.titleLabel.lineBreakMode];
    CGSize s = [self.titleLabel.text boundingRectWithSize:CGSizeMake(maxWidth, 1000) options:(NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading) attributes:nil context:nil].size;
...
{
	CGFloat maxWidth = self.width - (kTSAlertView_LeftMargin * 2);
    //CGSize s = [self.messageLabel.text boundingRectWithSize:options:attributes:context:: self.messageLabel.font constrainedToSize: CGSizeMake(maxWidth, 1000) lineBreakMode: self.messageLabel.lineBreakMode];
    CGSize s = [self.titleLabel.text boundingRectWithSize:CGSizeMake(maxWidth, 1000) options:(NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading) attributes:nil context:nil].size;
