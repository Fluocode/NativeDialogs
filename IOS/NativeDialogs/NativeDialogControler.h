...
@interface NativeDialogControler : NSObject <UIAlertViewDelegate,SBTableAlertDelegate, TSAlertViewDelegate,SBTableAlertDataSource,UIPopoverControllerDelegate,UIPickerViewDelegate>
{
